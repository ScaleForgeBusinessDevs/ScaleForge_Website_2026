...
const CAPABILITIES = [
  ...
  { title: "Content Strategy and Creation", href: "/services/content-creation" },
  ...
  return (
    <section className="bg-[#08080a] py-24 lg:py-32">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        ...
        <Reveal stagger staggerAmount={0.08} className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {STATS.map((stat) => (

    ...
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 rounded-2xl border border-white/[0.07] bg-[#101013] p-10 text-center">
        ...
        <p className="max-w-xs text-[14px] leading-relaxed text-white/60">
          We&apos;ll read it within 4 business hours and get back to you with
          sharper questions and a proposed call time.
        </p>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-1.5">
          <label
            htmlFor="name"
            className="font-accent text-[10px] uppercase tracking-[0.12em] text-white/40"
          >
      ...
      <div>
        ...
        <p className="mt-3 text-[12px] italic text-white/30">
          We typically respond within 4 business hours during our working window
          (Mon–Fri, flexible coverage across US/EU/AU time zones).
        </p>
      </div>
    </form>
  );

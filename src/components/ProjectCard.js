      ...
      <div className="relative h-full overflow-hidden rounded-2xl border border-white/[0.08] bg-[#161718]/60 backdrop-blur-md transition-all duration-300 hover:border-[#2563eb]/40 hover:shadow-xl hover:shadow-[#2563eb]/10">
        ...
        <div className="relative aspect-[16/10] overflow-hidden">
          ...
          {category && (
            <div className="absolute bottom-3 left-3">
              <span
                className={`rounded-full border px-2.5 py-0.5 text-[10px] font-[500] tracking-wide backdrop-blur-sm ${categoryStyle}`}
              >
                {category}
              </span>
            </div>
        ...
        <div className="flex flex-col gap-3 p-5">
          <div className="space-y-1.5">
            ...
            {client && (
              <p className="text-[11.5px] font-[450] uppercase tracking-[0.08em] text-white/35">
                {client}
              </p>
            )}
            {excerpt && (

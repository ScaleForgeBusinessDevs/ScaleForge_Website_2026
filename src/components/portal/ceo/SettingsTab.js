      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-white/40 text-xs">
            Configure global preferences and exchange rates
          </p>
        </div>
      </div>
      ...
      >
        <div className="p-5 border-b border-white/5 bg-white/2">
          ...
          <p className="text-white/30 text-xs mt-1">
            These rates are used globally across the dashboard when toggling
            between PKR and original currencies.
          </p>
        </div>
        ...
        <div className="p-6 space-y-5">
          {["USD", "EUR", "GBP"].map((currency) => (
            <div key={currency} className="flex items-center gap-4">
              ...
              <div className="w-12 text-white/30 text-xs font-bold uppercase">
                PKR
              </div>
            </div>
          ))}

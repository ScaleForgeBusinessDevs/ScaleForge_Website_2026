...
export default function PortalNav({ userName, role }) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <span
        className={`text-xs font-bold tracking-widest uppercase pr-4 border-r border-white/10 ${glowColor} text-white`}
      >
        Scale Forge
      </span>
      ...
      {/* Role badge */}
      <div
        className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest ${
          isCeo

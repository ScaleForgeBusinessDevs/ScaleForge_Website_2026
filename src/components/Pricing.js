      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-white/60">
            Select standard standalone plans or bundle multiple service tracks.
            Configure project deliverables or monthly retainers to match your
            growth objectives.
          </p>
        </Reveal>
        ...
        >
          {SERVICES_TEASER.map((service) => (
            ...
            >
              ...
              <h3 className="mt-5 text-[15.5px] font-medium text-white">
                {service.title}
              </h3>

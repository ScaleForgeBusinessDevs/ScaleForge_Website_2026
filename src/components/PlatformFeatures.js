...
const CONFIG_ITEMS = [
  { label: "Discovery & Scoping", icon: "api" },
  { label: "Design Approval", icon: "alert" },
  { label: "Development Sprint", icon: "sync" },
  { label: "QA & Testing", icon: "bolt" },
  { label: "Launch & Handoff", icon: "gauge" },
];
...
function ConfigIcon({ kind }) {
  const Icon = CONFIG_ICONS[kind];
  return <Icon size={15} className="text-white/60" aria-hidden />;
}
  ...
  return (
    <div className="group relative flex flex-1 flex-col gap-5 border border-white/[0.07] bg-white/[0.02] p-8 transition-colors duration-300 hover:border-white/[0.14] hover:bg-white/[0.035] lg:p-10">
      ...
      <div>
        ...
        <p className="mt-2.5 text-[14.5px] leading-relaxed text-white/40">
          {feature.body}
        </p>
      </div>
    </div>
      ...
      <div className="mx-auto max-w-[1300px] px-6 lg:px-10">
        <Reveal className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <p className="mt-5 max-w-md text-[16px] leading-relaxed text-white/60">
            A unified digital team of experts building, scaling, and managing
            your entire online footprint under one roof.
          </p>
        </Reveal>
        ...
        <Reveal
          stagger
          staggerAmount={0.12}
          className="mt-16 flex flex-col lg:flex-row lg:items-stretch"
        >
          ...
          <div className="relative overflow-hidden border border-white/[0.07] lg:min-h-[600px] lg:flex-[6]">
            <div className="absolute inset-0" aria-hidden>
              ...
              <div
                ...
                style={{ backgroundImage: "url(/Assets/stars.avif)" }}
              />
            ...
            <div className="relative flex h-full items-center justify-center p-8 sm:p-12">
              <div className="w-[280px] border border-white/10 bg-[#16161a]/95 p-6 shadow-[0_40px_100px_-24px_rgba(0,0,0,0.8)] backdrop-blur-2xl">
                <h4 className="font-accent text-[12px] uppercase tracking-[0.16em] text-white/55">
                  Project Pipeline
                </h4>

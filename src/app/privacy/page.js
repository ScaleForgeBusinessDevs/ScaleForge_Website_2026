...
const TOC = [
  ...
  { id: "sharing", label: "4. Sharing & Third Parties" },
  ...
  { id: "contact-privacy", label: "12. Contact" }
];
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1fr_220px]">
            ...
            <div className="max-w-[720px] space-y-12 text-[15px] leading-[1.75] text-white/55">
              <section id="intro">
                ...
                <p className="mt-4">
                  This policy applies to all visitors, leads, and clients. By
                  using the Site, you consent to the practices described here.
                </p>
              </section>
              ...
              <section id="collect">
                ...
                <h3 className="mb-2 text-[16px] font-medium text-white/80">
                ...
                <h3 className="mb-2 mt-5 text-[16px] font-medium text-white/80">
              ...
              <section id="cookies">
                ...
                <p className="mt-4">
                  ...
                  Site features may not function without them.
                </p>
              </section>
              ...
              <section id="rights">
                ...
                <p className="mb-3">
                  ...
                  for California residents, similar protections elsewhere), you
                  have the right to:
                </p>
                <ul className="ml-1 space-y-2">
                  {[
              ...
              <section id="transfers">
                ...
                <p>
                  ScaleForge operates from Pakistan. By using our services, you
                  understand and agree that your data may be transferred to,
                  stored in, and processed in countries outside your country of
                  residence, including Pakistan, the United States, and the
                  European Union. We rely on standard contractual safeguards for
              ...
              <section id="children">
                ...
                <p>
                  Our services are not directed at individuals under 13 years of
              ...
              <section id="changes">
                ...
                <p>
                  ...
                  Updated&quot; date. For significant changes, we&apos;ll
                  attempt to notify active clients and newsletter subscribers by
                  email.
                </p>
              </section>
              ...
              <section id="contact-privacy">
                ...
                <div className="rounded-2xl border border-white/[0.07] bg-[#101013] p-5">
                  ...
                  <p className="mt-1.5">
                    <strong className="text-white/70">Privacy lead:</strong>{" "}
                    Ruhan Bhaleshah (CTO)
                  </p>
                </div>
              </section>

        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_320px]">
          ...
          <div className="space-y-3">
            ...
            {[100, 90, 82, 100, 65, 95, 78, 100, 55].map((w, i) => (
              <div key={`b${i}`} className="h-4 animate-pulse rounded bg-white/[0.05]" style={{ width: `${w}%` }} />
            ))}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-[#101013] p-5">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="aspect-square w-full animate-pulse rounded-lg bg-white/[0.06]" />
                ))}
              </div>
            </div>
          </div>

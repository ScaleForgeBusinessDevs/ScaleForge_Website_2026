...
const PAYMENT = [
  ...
  { label: "Wise / Payoneer", icon: Landmark },
  { label: "Upwork / Contra Escrow", icon: ShieldCheck }
];
...
export default function About() {
  ...
  return (
    <>
      ...
      <section className="bg-[#08080a] py-24 lg:py-32">
        <div className="mx-auto max-w-[1100px] px-6 lg:px-10">
          <Reveal>
            ...
            <div className="mt-15 space-y-5 text-[15px] leading-relaxed text-center text-white/60">
              <p>
                ...
                Companies Act 2017, structured as a two-founder firm with a
                clear ownership split and operating mandate. From the beginning,
                the bet was the same: combine elite hand-coded engineering with
                aggressive search visibility, do the work for a deliberately
                small cohort each season, and let the receipts compound. Today,
      ...
      {/* The Founders */}
      <section
        className="relative overflow-hidden border-t border-white/[0.06] pb-40 pt-24 lg:pb-56 lg:pt-32"
        ...
        <div className="relative mx-auto max-w-[1100px] px-6 lg:px-10">
          ...
          <Reveal className="mx-auto mb-16 flex max-w-2xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/60">
              A highly dedicated team combining elite engineering and high-ROI
              digital strategy.
            </p>
          </Reveal>
              ...
              <div className="group flex flex-col">
                ...
                <div className="mt-5">
                  ...
                  <p className="mt-3 text-[14px] leading-relaxed text-white/50">
                    Shahood isn&apos;t just part of Scale Forge&apos;s success,
                    he is Scale Forge&apos;s success. The strategist, the
                    closer, the architect of every custom Next.js build the
                    agency ships. He owns the client relationships from first
                    cold DM to final invoice, runs the social media branding and
                    management personally, and sets the engineering bar for
                    performance and scalability along the way. Bring him a
                    problem; he&apos;ll bring back a growth curve, a shipped
                    build, and a mic drop, because there&apos;s no part of this
                    pipeline he doesn&apos;t touch.
                  </p>
                  <div className="mt-5 flex items-center gap-2.5">
                    <a
                      href="https://www.linkedin.com/in/shahood-saleem/"
                      target="_blank"
            ...
            <Reveal>
              <div className="group flex flex-col">
                ...
                <div className="mt-5">
                  ...
                  <p className="mt-3 text-[14px] leading-relaxed text-white/50">
                    Ruhan handles SEO, the technical audits, the keyword grind,
                    the unglamorous crawl reports nobody reads until rankings
                    move. He works in the margins of what Shahood builds,
                    quietly making sure Google notices the sites long after
                    launch day. No client calls, no spotlight just the guy
                    tuning the algorithm's opinion of you from the shadows.
                  </p>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          >
            {BELIEFS.map((belief) => (
              ...
              >
                <h3 className="text-[16px] font-medium italic text-white">
                  {belief.title}
                </h3>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          >
            {FACTS.map((fact) => (
              ...
              >
                ...
                <p className="mt-2 text-[13.5px] font-medium leading-snug text-white/75">
                  {fact.value}
                </p>
              </div>
            ))}
          ...
          <Reveal className="mt-8 flex flex-wrap items-center justify-center gap-4">
            {PAYMENT.map((p) => (
              <div
                key={p.label}
                className="flex items-center gap-2.5 rounded-full border border-white/[0.07] px-5 py-2.5"
              >
        ...
        <div className="mx-auto max-w-[860px] px-6 text-center lg:px-10">
          <Reveal>
            <p className="text-[15px] italic leading-relaxed text-white/60">
              Always interested in connecting with senior engineers, designers,
              and SEO specialists. Email{" "}
              <a
                href="mailto:scaleforgebusinessdev@gmail.com"

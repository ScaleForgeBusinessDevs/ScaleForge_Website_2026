        ...
        <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 pb-16 pt-32 lg:px-10 lg:pt-28">
          <Reveal className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-white/45">
              Whether you have a fully-scoped project or a half-formed idea, we&apos;d like to hear about it. Pick
              whichever channel works best for you below.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_340px]">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-2xl border border-white/[0.07] bg-[#101013] p-7 lg:sticky lg:top-32">
                <h3 className="text-[16px] font-medium text-white">What happens next?</h3>
                <ol className="mt-5 flex flex-col gap-5">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-4">
                      ...
                      <p className="pt-0.5 text-[13.5px] leading-relaxed text-white/50">{step}</p>
                    </li>
                  ))}
                </ol>
            ...
            {DIRECT_CHANNELS.map((ch) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[14px] font-medium text-white">{ch.value}</p>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          <Reveal stagger className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {OFFICE_TILES.map((tile) => (
              ...
              >
                <p className="font-accent text-[10px] uppercase tracking-[0.12em] text-white/35">{tile.label}</p>
                <p className="mt-2 text-[15px] font-medium text-white">{tile.value}</p>
              </div>
            ))}
          </Reveal>
        </div>
        ...
        <div className="relative mx-auto max-w-[620px] px-6 lg:px-10">
          <Reveal className="text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/45">
              If you&apos;re not ready to fill out a form or book a call but want to keep ScaleForge on your radar, our
              weekly newsletter delivers one actionable insight per week — no spam.
            </p>
            <NewsletterForm />
          </Reveal>
        </div>

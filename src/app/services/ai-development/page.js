...
export const metadata = {
  ...
  alternates: {
    canonical: "https://scalesforge.site/services/ai-development",
    languages: {
  ...
  openGraph: {
    title:
      "AI Development & Automation Services | ScaleForge",
    description:
      "Build AI automation that scrapes leads, runs cold-calling agents, and publishes social content 24/7. ScaleForge builds with n8n, Make, Vapi, and Zapier.",
    url: "https://scalesforge.site/services/ai-development",
    siteName: "ScaleForge",
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
      {steps.map((step, i) => (
        <div
          key={step.title}
          className="flex flex-col gap-3 rounded-2xl border border-white/[0.07] bg-[#101013] p-6"
        >
...
const BUILD_PROCESS = [
  { step: "01", title: "Discovery & Audit", body: "We map every manual workflow in your business, identify automation opportunities, and prioritize by ROI impact." },
  { step: "02", title: "Stack Selection", body: "We choose the right combination of tools (n8n, Make, Zapier, Vapi) based on your budget, data sensitivity, and scale needs." },
  { step: "03", title: "Build & Integrate", body: "We connect your systems, build the automation flows, and wire up AI agents with live testing across all edge cases." },
  { step: "04", title: "Test & Optimize", body: "Every workflow is stress-tested across real data volumes. We fix failures, tune AI prompts, and optimize trigger logic." },
  { step: "05", title: "Hand-off & Monitor", body: "We deliver full documentation, train your team, and provide ongoing monitoring to keep automations running perfectly." },
];
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "item": "https://scalesforge.site/services/ai-development"
        }
    ]
};
  const productSchema = {
        ...
        <div className="mx-auto max-w-[1200px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            <p className="mx-auto mt-7 max-w-6xl text-[clamp(1.2rem,5vw,1.8rem)] font-normal leading-[1.3] text-white">
              &ldquo;Businesses that automate repetitive tasks recover an
              average of 6+ hours per employee per week and reduce lead response
              time by up to 80%.&rdquo;
            </p>
            <p className="mx-auto mt-7 max-w-xl text-[14.5px] font-inter leading-relaxed text-white/60">
              Every hour your team spends copying data, chasing leads, or
              manually posting content is an hour not spent closing deals,
              building relationships, or scaling your offer. We close that gap
              with custom-built automation that runs while your team sleeps.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          >
            {LEAD_GEN_STATS.map((stat) => (
              ...
              >
                <p className="text-[24px] font-bold tracking-[-0.01em] text-white">
                  {stat.value}
                </p>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          <Reveal className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[1.2fr_1fr]">
            <div className="rounded-2xl border border-white/[0.07] bg-[#101013] p-7">
              <p className="font-accent text-[10px] uppercase tracking-[0.18em] text-white/40">
                What Vapi Replaces
              </p>
              <ul className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {VAPI_REPLACES.map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-2.5 rounded-md border border-white/[0.06] bg-white/[0.015] px-3.5 py-2.5 text-[12.5px] leading-relaxed text-white/55"
                  >
            ...
            <div className="flex flex-col items-center justify-center gap-2 rounded-2xl border border-white/20 bg-[#101013] p-10 text-center shadow-[0_40px_120px_-50px_rgba(255,255,255,0.25)]">
              <p className="text-[40px] font-bold tracking-[-0.02em] text-white">
                80%
              </p>
              <p className="text-[12px] uppercase leading-snug tracking-[0.1em] text-white/60">
                Reduction in SDR Cost
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          >
            {PLATFORMS.map((platform) => (
              <span
                key={platform}
                className="rounded-full border border-white/10 bg-white/[0.02] px-5 py-2.5 text-[13px] text-white/55"
              >
                {platform}
              </span>
            ))}

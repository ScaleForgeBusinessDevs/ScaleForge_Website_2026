...
const CAPABILITIES = [
  { title: "Business Websites", body: "Highly customized web presences from 5 to 30+ pages, built with semantic HTML and full metadata schemas to secure top-tier organic visibility.", icon: Globe },
  { title: "E-Commerce Portals", body: "Supersonic online stores featuring advanced catalogs, instant checkout, secure payment pipelines, and custom inventory databases.", icon: ShoppingBag },
  { title: "Landing Pages", body: "Single-page lightweight React applications built specifically for extreme loading speeds and automated Google Ads conversions.", icon: Zap },
  { title: "Web Application Interfaces", body: "Clean, reliable, and responsive React/Next.js client-facing frontends tailored for SaaS products and online platforms.", icon: Sidebar }
];
...
const FAQS = [
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "item": "https://scalesforge.site/services/web-development"
        }
    ]
};
  const productSchema = {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-[860px] px-6 text-center lg:px-10">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-[15px] leading-relaxed text-white/60">
              Google uses loading speed as an explicit mobile search ranking
              factor. Over{" "}
            ...
            <p className="mx-auto mt-5 max-w-2xl text-[15px] leading-relaxed text-white/60">
              ...
              headstart over legacy platforms. Sub-1.5-second load times.
              Perfect Lighthouse scores. Zero bloat. Every component earns its
              place.
            </p>
          </Reveal>
        </div>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          <Reveal className="mt-6 overflow-hidden rounded-2xl border border-white/[0.07] bg-[#101013] p-6 font-mono text-[12.5px] leading-relaxed">
            ...
            <p className="pl-4 text-white/55">
              ...
              <span className="text-[#e8633a]">await</span>{" "}
              fetchData(params.slug);
            </p>
            <p className="pl-4 text-white/55">
              <span className="text-[#6fcf8e]">return</span> &lt;
              <span className="text-white/80">PageContent</span> data={"{data}"}{" "}
              /&gt;;
            </p>
            <p>{"}"}</p>
          ...
          <Reveal className="mt-14 overflow-hidden rounded-2xl border border-white/[0.07]">
            <div className="hidden grid-cols-4 gap-x-4 border-b border-white/[0.07] bg-white/[0.02] px-6 py-3 sm:grid">
              {[
                ...
                <p
                  key={h}
                  className="font-accent text-[10px] uppercase tracking-[0.14em] text-white/40"
                >
                  {h}
                </p>
              ))}
      ...
      <FAQAccordion
        eyebrow="CLARITY"
        heading="Technical Frequently Asked Questions"
        questions={FAQS}
      />

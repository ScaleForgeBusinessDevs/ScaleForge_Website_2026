...
const OFFERINGS = [
  { title: "Custom UI Design", body: "Absolutely zero pre-made templates. Every layout, margin, and hover effect is drawn from scratch to match your specific brand personality and goals.", icon: PenTool },
  { title: "UX & Conversion Architecture", body: "We define logical page hierarchies, smooth content layouts, and strategic CTA placements that eliminate scrolling fatigue and drive engagement.", icon: Split },
  { title: "Mobile-First Responsive Design", body: "Over 60% of organic traffic is mobile. We design for the smallest screen widths first and scale upward, ensuring your site looks flawless on every device.", icon: Smartphone },
  { title: "Brand Identity & Style Guides", body: "Logo refinement, harmonized HSL color palettes, modern typography selections, and a comprehensive spacing guide to keep your brand coherent across every touchpoint.", icon: Palette },
  { title: "Landing Page Optimization", body: "High-converting standalone single-page systems specifically tuned for Google Ads, social media campaigns, and fast lead acquisition.", icon: Rocket }
];
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "item": "https://scalesforge.site/services/web-design"
        }
    ]
};
  const productSchema = {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{
          label: "Book a Free Design Briefing",
        ...
        <div className="mx-auto max-w-[1100px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            <p className="mx-auto mt-7 text-[clamp(1.4rem,3vw,1.9rem)] font-display font-normal leading-[1.3] text-white">
              &ldquo;It takes only 50 milliseconds (0.05 seconds) for users to
              form an opinion about your website&apos;s aesthetic and decide
              whether they will stay or leave.&rdquo;
            </p>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            ...
            <Reveal className="rounded-2xl border border-white/[0.07] bg-[#101013] p-8">
              ...
              <p className="mt-3 text-[15px] italic leading-relaxed text-white/65">
                100% custom wireframes in Figma. No templates. No stock layouts.
                No exceptions.
              </p>
            </Reveal>
          </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13.5px] leading-relaxed text-white/60">
                    {i === 4 ? (
                      <>
                        Exporting clean asset packages, documented component
                        margins, and motion spec assets for{" "}
                        <Link
      ...
      <FAQAccordion
        eyebrow="CLARITY"
        heading="Design Frequently Asked Questions"
        questions={FAQS}
      />

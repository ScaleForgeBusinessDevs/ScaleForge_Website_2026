...
import { Palette, BarChart2, Camera, PenTool, Megaphone, Check, Quote } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://scaleforgewebdev.vercel.app/services/social-media-branding",
  },
  openGraph: {
    title: "Social Media Branding Services | ScaleForge",
    description:
      "ScaleForge builds cohesive social media brand identities — visual systems, content frameworks, and channel strategy — that make your brand instantly recognisable and impossible to ignore.",
    url: "https://scaleforgewebdev.vercel.app/services/social-media-branding",
    siteName: "ScaleForge",
...
const OFFERINGS = [
  {
    ...
    body: "Custom color palettes, typography pairings, icon sets, and a comprehensive brand guideline document that keeps every post, story, and reel unmistakably yours.",
  },
  {
    icon: Camera,
    title: "Content Template Design",
    body: "A full library of editable Canva or Figma templates — post formats, carousel slides, story frames, and highlight covers — designed to your brand and ready for your team to use daily.",
  },
  {
    icon: PenTool,
    title: "Profile & Bio Optimisation",
    body: "Profile pictures, banner artwork, keyword-optimised bios, and link-in-bio pages that communicate authority and drive clicks across LinkedIn, Instagram, and X.",
  },
  {
    icon: BarChart2,
    title: "Content Strategy & Calendar",
    body: "A data-driven content strategy defining your pillars, posting frequency, hook frameworks, and a 30-day editorial calendar mapped to your business goals.",
  },
  {
    icon: Megaphone,
    title: "Brand Voice Guidelines",
    body: "A documented brand voice playbook — tone, vocabulary, do's and don'ts — so every caption and comment sounds like you, whether written by the founder or a hired copywriter.",
  },
];
...
const FAQS = [
  {
    ...
    a: "We cover LinkedIn, Instagram, X (Twitter), Facebook, TikTok, and YouTube. Most branding engagements focus on 2–3 platforms chosen based on where your audience is most concentrated. We always recommend LinkedIn for B2B and Instagram for B2C as starting points.",
  },
  {
    q: "Do I need to have an existing brand before starting?",
    a: "No. We can work from scratch — starting with just your business name and a rough sense of your audience and values. If you have existing brand assets (logo, colours, fonts), we'll build on them. If you don't, we create them from the ground up as part of the engagement.",
  },
  {
    q: "How long does the branding process take?",
    a: "A full social media branding engagement typically takes 3–4 weeks: one week for discovery and audit, one to two weeks for identity design and feedback cycles, and one week for template production and strategy delivery.",
  },
  {
    q: "Will my team be able to use the templates independently?",
    a: "Yes — that's the whole point. All templates are built in Canva or Figma with clearly labelled layers, locked brand elements, and editable text/image zones. We walk your team through every template in a recorded handoff session.",
  },
  {
    q: "Can you also manage our social media after the branding is done?",
    a: "We don't offer ongoing social media management directly, but we can connect you with our AI automation pipelines that auto-generate and schedule content, or refer you to trusted content management partners in our network.",
  },
];
...
export default function SocialMediaBrandingPage() {
  const serviceSchema = {
    ...
    "serviceType": "Brand Identity & Social Media Strategy",
    "provider": {
      "@type": "Organization",
      "name": "ScaleForge",
    ...
    "description":
      "ScaleForge builds cohesive social media brand identities — visual systems, content frameworks, and channel strategy — that make your brand instantly recognisable.",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{ label: "Book a Free Brand Review", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}
        ...
        <div className="mx-auto max-w-[1100px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            <p className="mx-auto mt-7 text-[clamp(1.4rem,3vw,1.9rem)] font-display font-normal leading-[1.3] text-white">
              &ldquo;It takes only 0.05 seconds for people to form an opinion about your brand on social media.
              Consistent visual branding increases revenue by up to 33%.&rdquo;
            </p>
            <p className="mx-auto mt-7 max-w-xl text-[14.5px] leading-relaxed text-white/45">
              Most businesses post inconsistently, use mismatched fonts and colours, and wonder why their follower count
              stagnates. A cohesive brand system removes all of that friction — your audience immediately knows who you
              are and what you stand for, every single time they see your content.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            ...
            <Reveal className="rounded-2xl border border-white/[0.07] bg-[#101013] p-8">
              ...
              <p className="mt-3 text-[15px] italic leading-relaxed text-white/65">
                Every template we hand off is designed to be used the same day. No design skills needed. No guessing. Just open, edit, and post.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <FAQAccordion eyebrow="CLARITY" heading="Social Media Branding FAQs" questions={FAQS} />

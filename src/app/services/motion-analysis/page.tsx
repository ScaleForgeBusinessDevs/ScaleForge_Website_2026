...
import { Crosshair, ClipboardList, Activity, FileBarChart, Layers, Check, Quote } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://scaleforgewebdev.vercel.app/services/motion-analysis",
  },
  openGraph: {
    title: "Motion Analysis & Time and Motion Study | ScaleForge",
    description:
      "ScaleForge delivers digital time and motion studies — capturing, analysing, and optimising workforce activity to eliminate inefficiency and increase throughput without adding headcount.",
    url: "https://scaleforgewebdev.vercel.app/services/motion-analysis",
    siteName: "ScaleForge",
...
const OFFERINGS = [
  {
    icon: Crosshair,
    title: "Digital Time Studies",
    body: "Precision time capture across every task element using digital tools — replacing stopwatch-and-clipboard with structured data collection that is faster, more accurate, and instantly analysable.",
  },
  {
    icon: Activity,
    title: "Motion & Workflow Mapping",
    body: "Spaghetti diagrams, process flow maps, and value-stream mapping of physical and digital workflows to visualise exactly where time, movement, and effort are being wasted.",
  },
  {
    icon: Layers,
    title: "Efficiency Benchmarking",
    body: "We establish performance baselines and compare them against industry standards, best-in-class benchmarks, and internal variance to identify your highest-ROI improvement targets.",
  },
  {
    icon: ClipboardList,
    title: "Work Sampling Studies",
    body: "Statistical sampling of workforce activity across shifts to determine the ratio of productive, semi-productive, and non-productive time without continuous observation.",
  },
  {
    icon: FileBarChart,
    title: "Digital Reports & Dashboards",
    body: "Comprehensive digital study reports with interactive charts, standard time calculations, efficiency ratings, and prioritised improvement recommendations — ready to share with leadership.",
  },
];
...
const FAQS = [
  ...
  {
    q: "How long does a study take to complete?",
    a: "Study duration depends on the number of tasks, shifts, and work centres in scope. A focused single-department study typically takes 1–2 weeks of observation followed by 1 week of analysis and reporting. Multi-site or cross-functional studies covering multiple departments can run 4–8 weeks. We always begin with a scoping call to produce a precise timeline estimate.",
  },
  {
    q: "Will workers be aware they are being studied?",
    a: "We always recommend transparent communication with the workforce before a study begins. Research consistently shows that workers who understand the purpose of a study — improving workflows, not replacing jobs — produce more representative data and are more receptive to the resulting changes. We can provide a communication template for your team.",
  },
  {
    q: "Do you provide implementation support after the study?",
...
export default function MotionAnalysisPage() {
  const serviceSchema = {
    ...
    "serviceType": "Operations Consultancy",
    "provider": {
      "@type": "Organization",
      "name": "ScaleForge",
    ...
    "description":
      "ScaleForge delivers digital time and motion studies — capturing, analysing, and optimising workforce activity to eliminate inefficiency and increase throughput.",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{ label: "Book a Free Study Scoping Call", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}
        ...
        <div className="mx-auto max-w-[1100px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            <p className="mx-auto mt-7 text-[clamp(1.4rem,3vw,1.9rem)] font-display font-normal leading-[1.3] text-white">
              &ldquo;Studies consistently show that 25–40% of time in a typical manufacturing or logistics operation
              is non-value-adding. A rigorous motion study recovers most of it.&rdquo;
            </p>
            <p className="mx-auto mt-7 max-w-xl text-[14.5px] leading-relaxed text-white/45">
              Most operational improvement initiatives fail because they target symptoms — adding headcount, extending
              shifts, or investing in automation — without first understanding exactly how current time and motion is
              allocated. A time and motion study gives you the diagnostic data to make changes that actually work.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          <Reveal className="mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/45">
              We combine industrial engineering methodology with modern digital tools to deliver studies that are faster, more accurate, and more actionable than traditional approaches.
            </p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            ...
            <Reveal className="rounded-2xl border border-white/[0.07] bg-[#101013] p-8">
              ...
              <p className="mt-3 text-[15px] italic leading-relaxed text-white/65">
                We don&apos;t just hand you a spreadsheet. Every study ends with a specific, sequenced, costed improvement roadmap — so your operations team knows exactly what to do on Monday morning.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <FAQAccordion eyebrow="CLARITY" heading="Time & Motion Study FAQs" questions={FAQS} />

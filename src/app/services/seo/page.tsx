...
const FAQS = [
  ...
  },
  {
    ...
    a: "For low-competition keywords, you can see ranking movement within 60 to 90 days. For competitive commercial keywords, expect 6 to 9 months before you see top-of-page rankings. SEO is a long game — anyone promising page-one rankings in 30 days is either lying or using tactics that will get you penalized.",
  },
  {
    q: "What is local SEO and how does it help service businesses?",
    a: "Local SEO is the discipline of ranking in the 'Map Pack' — the three local business listings that appear above traditional results when someone searches for a service near them. For service businesses (dentists, lawyers, plumbers, home services), local SEO is often higher-ROI than national SEO because the intent is purchase-ready.",
  },
  {
    q: "How do backlinks help my search rankings?",
    a: "Backlinks are votes of confidence. When another website links to yours, search engines interpret it as a signal that your content is trustworthy and worth citing. The number, quality, and topical relevance of those links is one of the strongest ranking factors Google uses. We earn backlinks through editorial outreach and digital PR — never through link farms or paid networks.",
  },
  {
    q: "What is the difference between on-page and off-page SEO?",
    a: "On-page SEO is what we control on your website — titles, headings, content quality, internal linking, schema. Off-page SEO is what happens outside your website — backlinks, brand mentions, social signals. A complete SEO strategy needs both. We deliver both.",
  },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{ label: "Book a Free SEO Audit", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}
        ...
        <div className="mx-auto max-w-[860px] px-6 text-center lg:px-10">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-[15px] leading-relaxed text-white/45">
              Paid advertising stops generating traffic the exact microsecond you stop paying. Organic search traffic
              is the opposite — it&apos;s a compounding asset. A single keyword cluster ranked today keeps generating
              qualified leads day after day, month after month, costing nothing per click.
            </p>
            <p className="mx-auto mt-5 max-w-2xl text-[15px] leading-relaxed text-white/45">
              By positioning your brand at the exact moment your prospects are searching for solutions, you bypass
              high ad bids and establish instant market authority. Done right, SEO becomes the lowest-cost,
        ...
        <div className="mx-auto max-w-[1100px] px-6 lg:px-10">
          <Reveal className="mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/45">
              SEO requires consistency. Here&apos;s a realistic roadmap for the first 12 months of partnership.
            </p>
          </Reveal>

          <Reveal stagger staggerAmount={0.08} className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {TIMELINE.map((item, i) => (
              <div key={item.phase} className="relative rounded-2xl border border-white/[0.07] bg-[#101013] p-6">
                <span className="font-accent text-[10px] uppercase tracking-[0.14em] text-[#e8633a]/70">{item.phase}</span>
                ...
                <div>
                  <h3 className="text-[15px] font-medium text-white">
                    {i === 3 ? (
                      <>
                        Content &amp;{" "}
                        <Link href="/services/content-creation" className="text-white/60 underline decoration-white/20 underline-offset-4 hover:text-white">
                          Link Outreach
                        </Link>
                      </>
                    ) : (
      ...
      <FAQAccordion eyebrow="CLARITY" heading="SEO Frequently Asked Questions" questions={FAQS} />
      ...
      <CTASection
        ...
        primaryCta={{ label: "Get a Free SEO Audit", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}

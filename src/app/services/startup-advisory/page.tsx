...
import { Lightbulb, LineChart, Megaphone, Target, Users, Check, Quote } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://scaleforgewebdev.vercel.app/services/startup-advisory",
  },
  openGraph: {
    title: "Startup Advisory Services | Strategic Mentorship from ScaleForge",
    description:
      "ScaleForge provides hands-on startup advisory: pitch deck creation, fundraising strategy, go-to-market planning, and investor introductions for early-stage founders.",
    url: "https://scaleforgewebdev.vercel.app/services/startup-advisory",
    siteName: "ScaleForge",
...
const OFFERINGS = [
  {
    ...
    body: "We map your ICP, define your positioning statement, identify the fastest acquisition channels, and build a phased GTM roadmap that minimises burn while maximising early traction.",
  },
  {
    icon: Lightbulb,
    title: "Pitch Deck Creation",
    body: "Investor-ready decks that tell a compelling narrative: problem, solution, market size, traction, team, and ask — structured to survive the first 90-second filter from a VC associate.",
  },
  {
    icon: LineChart,
    title: "Fundraising Strategy",
    body: "We advise on round sizing, valuation anchoring, SAFE vs. priced round mechanics, and which investor archetypes to target at each stage — from pre-seed angels to Series A funds.",
  },
  {
    icon: Users,
    title: "Investor Introductions",
    body: "Warm introductions to our network of angel investors, syndicate leads, and early-stage VCs actively deploying capital in your sector — so your outreach starts at second base.",
  },
  {
    icon: Megaphone,
    title: "OKR & KPI Framework Setup",
    body: "Define the right metrics to track at your stage, set up a lightweight OKR system your team will actually use, and build a weekly cadence that keeps execution locked to strategy.",
  },
];
...
const FAQS = [
  {
    q: "What stage startups do you work with?",
    a: "We focus on pre-seed through Series A. The sweet spot is a founder who has a working MVP and at least some early user traction but hasn't yet formalised their fundraising strategy or GTM playbook. We occasionally take on idea-stage founders with unusually strong domain expertise.",
  },
  {
    q: "Do you take equity in exchange for advisory?",
    a: "We offer both fee-based and equity-based advisory arrangements depending on the engagement length and the founder's preference. Equity arrangements are typically 0.25–0.75% with a 12–24 month cliff and standard vesting. We're happy to discuss what structure makes most sense for your situation.",
  },
  {
    q: "How are advisor sessions structured?",
    a: "Standard engagements include one structured 60-minute call per week. Before each call you submit an update covering metrics, blockers, and questions. We review it in advance and arrive prepared to go deep — no status update theatre, just high-signal strategic discussion.",
  },
  {
    q: "Can you help us if we're not fundraising yet?",
    a: "Absolutely. Many of our most impactful advisory relationships start long before a fundraise — working on pricing strategy, hiring sequence, product positioning, and channel selection. Getting these fundamentals right dramatically shortens the time between founding and a fundable traction story.",
  },
  {
    q: "What sectors do you have the deepest expertise in?",
    a: "We have the strongest networks and pattern recognition in B2B SaaS, AI/ML tooling, digital media, and professional services tech. We also work with consumer brands and marketplace businesses where the founder brings strong domain expertise we can complement.",
  },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{ label: "Book a Free Founder Call", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}
        ...
        <div className="mx-auto max-w-[1100px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            ...
            <p className="mx-auto mt-7 max-w-xl text-[14.5px] leading-relaxed text-white/45">
              The difference between a startup that survives and one that scales is rarely the idea — it&apos;s the
              quality of strategic decisions made in the first 18 months. A great advisor compresses your learning
              curve, prevents expensive mistakes, and opens doors that take years to open alone.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          <Reveal className="mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/45">
              Every engagement is different. We focus on the highest-leverage work for your current stage.
            </p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            ...
            <Reveal className="rounded-2xl border border-white/[0.07] bg-[#101013] p-8">
              ...
              <p className="mt-3 text-[15px] italic leading-relaxed text-white/65">
                We don&apos;t do generic mentorship. Every session is prepared, agenda-driven, and designed to produce a concrete output you can act on the same week.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <FAQAccordion eyebrow="CLARITY" heading="Startup Advisory FAQs" questions={FAQS} />

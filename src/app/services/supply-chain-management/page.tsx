...
import { BarChart2, TrendingUp, Package, Truck, GitBranch, Check, Quote } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://scaleforgewebdev.vercel.app/services/supply-chain-management",
  },
  openGraph: {
    title: "Supply Chain Management Software | Sales Forecasting | ScaleForge",
    description:
      "ScaleForge builds custom supply chain management software with AI-powered sales forecasting, inventory optimisation, and supplier analytics — purpose-built for your operations.",
    url: "https://scaleforgewebdev.vercel.app/services/supply-chain-management",
    siteName: "ScaleForge",
...
const OFFERINGS = [
  {
    ...
    body: "Machine learning models trained on your historical sales data, seasonality patterns, and external signals to produce accurate demand forecasts at SKU, category, and regional levels.",
  },
  {
    icon: Package,
    title: "Inventory Optimisation",
    body: "Automated reorder point calculations, safety stock modelling, and dead-stock alerts that prevent both stockouts and costly overstock situations across your warehouse network.",
  },
  {
    icon: Truck,
    title: "Supplier & Procurement Analytics",
    body: "Real-time dashboards tracking supplier lead times, fill rates, and cost variance — so you can renegotiate from a position of data and identify single-source risks before they become crises.",
  },
  {
    icon: GitBranch,
    title: "ERP & Systems Integration",
    body: "Seamless two-way integrations with SAP, Oracle, Microsoft Dynamics, Odoo, and custom ERP systems — your forecast data flows automatically without manual re-entry.",
  },
  {
    icon: BarChart2,
    title: "Executive Reporting Dashboards",
    body: "Role-specific dashboards for operations managers, finance teams, and C-suite — showing the KPIs each stakeholder needs without the noise they don't.",
  },
];
...
const PROCESS = [
  { title: "Operations Audit", body: "We map your current supply chain flows, data sources, pain points, and the specific forecasting and reporting gaps costing you money today." },
...
const FAQS = [
  {
    ...
    a: "At minimum, 12–24 months of historical sales data at SKU or product category level. Better models come with additional signals: promotional calendars, seasonality flags, supplier lead times, and external data like economic indicators or web traffic. We conduct a data audit at the start of every engagement to assess what you have and what we can supplement.",
  },
  {
    q: "Can you integrate with our existing ERP system?",
  ...
  {
    q: "How accurate are the sales forecasts?",
    a: "Accuracy varies by industry and data quality, but our models typically achieve 85–96% accuracy at the 30-day horizon for established product lines with 18+ months of clean historical data. New products, highly seasonal categories, and markets with significant external volatility will have wider confidence intervals, which we model explicitly.",
  },
  {
    q: "Do we need a data team to maintain the system?",
    a: "No. We build systems designed to be maintained by operations or finance teams without data science backgrounds. Models are retrained automatically on a scheduled basis. You receive clear accuracy reports and drift alerts so you always know when a model needs attention — and we handle the retraining under a maintenance contract.",
  },
  {
...
export default function SupplyChainManagementPage() {
  const serviceSchema = {
    ...
    "description":
      "ScaleForge builds custom supply chain management software with AI-powered sales forecasting, inventory optimisation, and supplier analytics.",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        primaryCta={{ label: "Book a Free Operations Review", href: "https://cal.com/shahood-saleem-gbzisb/30min" }}
        ...
        <div className="mx-auto max-w-[1100px] px-6 text-center lg:px-10">
          <Reveal className="flex flex-col items-center">
            <p className="mx-auto mt-7 text-[clamp(1.4rem,3vw,1.9rem)] font-display font-normal leading-[1.3] text-white">
              &ldquo;Companies with advanced supply chain capabilities achieve 15% lower supply chain costs,
              50% less inventory holdings, and 3× faster cash-to-cash cycles.&rdquo;
            </p>
            <p className="mx-auto mt-7 max-w-xl text-[14.5px] leading-relaxed text-white/45">
              Most mid-market businesses still forecast demand in Excel and track inventory in disconnected spreadsheets.
              The gap between where they are and where a custom platform could take them is measured in seven figures of
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          <Reveal className="mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-white/45">
              Every module is purpose-built for your operations — not a generic SaaS platform forced to fit your workflow.
            </p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
            ...
            <Reveal className="rounded-2xl border border-white/[0.07] bg-[#101013] p-8">
              ...
              <p className="mt-3 text-[15px] italic leading-relaxed text-white/65">
                We don&apos;t sell you a generic SaaS licence with 80% of features you&apos;ll never use. We build exactly what your supply chain needs — nothing more, nothing less.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <FAQAccordion eyebrow="CLARITY" heading="Supply Chain Software FAQs" questions={FAQS} />
